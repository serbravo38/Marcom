¡Hola, Julio! Como tu copiloto técnico, he preparado el contenido completo para actualizar el archivo **`README.md`** de tu repositorio en GitHub.

Este ajuste cumple estrictamente con el **Anexo 2 (Requisitos y Buenas Prácticas de GitHub)** del instructivo oficial de Capstone, integrando tu **doble rol (Frontend Developer & QA Lead)** y detallando la ejecución completa del entorno distribuido mediante **Docker Compose**[cite: 1, 11].

Copia y pega la siguiente estructura en la raíz de tu proyecto en el archivo `README.md`:
...
| :--- | :--- | :--- |
| **Julio Cesar Mena Torres** | **Frontend Developer & QA Lead** | Desarrollo de la SPA en React + TypeScript, maquetado con Tailwind CSS, consumo de API Gateway, captura de evidencias digitales, desarrollo del Dashboard de KPIs y ejecución de la suite de pruebas unitarias/integración (Jest / React Testing Library). |
