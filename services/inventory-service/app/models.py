...
class Ubicacion(Base):
    ...
    cantidad_pantallas = Column(Numeric(5, 0), nullable=True, default=0)
    precio_instalacion_uf = Column(Numeric(10, 2), nullable=True, default=0.00)
    precio_transporte_uf = Column(Numeric(10, 2), nullable=True, default=0.00)
